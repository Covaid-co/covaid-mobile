...
=======
  ...
  const fetchUser = async (id) => {
    // TODO: use authenticated version of this
>>>>>>> dacfdd7ae71d6c6f163ceebc0e9b0890520a752e
    let params = { id: id };
  ...
  function generateRequestList(requestData, requestStateChanger) {
    ...
    for (var i = 0; i < requestData.length; i++) {
      ...
      var element = {
        ...
        requester_contact:
          requestData[i].requester_email || requestData[i].requester_phone,
...
=======
  ...
  function displayRequestInfo(reqType, item) {
      ...
      return (
        <>
          ...
          <Text style={texts.request_text}>
            Request resources: {item.resources}
          </Text>
          <Text style={texts.request_text}>Needed by: {item.needed_by}</Text>
        </>
      );
    } else if (reqType == volunteer_status.COMPLETE) {
      // TODO verify with website if this is the info that has to be shown
      return (
        <>
          <Text style={texts.request_title}>{item.requester_name}</Text>
          <Text style={texts.request_text}>
    ...
    return <Text style={texts.header}>Obtaining details...</Text>;
  }
  ...
  function displayRequestModal(reqType, item) {
    ...
    return <Text style={texts.header}>Obtaining request data...</Text>;
  }
>>>>>>> dacfdd7ae71d6c6f163ceebc0e9b0890520a752e
}
